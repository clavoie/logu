...
// goLogger is an implementation of Logger that uses the
// Go logging package to write to os.Stdout for debug and info messages,
// and os.Stderr for warning and error messagees:
//
...
// NewGoLogger creates an implementation of Logger that uses the
// Go logging package to write to os.Stdout for debug and info messages,
// and os.Stderr for warning and error messagees:
//
// https://golang.org/pkg/log/
